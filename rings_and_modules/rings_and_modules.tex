...
% I retypeset the pdf on April 29, 2022 to update the style.
...
Suppose $R$ is a ring. One defines the multiplication in the \defn{opposite ring}\index{opposite ring} $\op R$ of $R$ as follows:
\begin{align*}
...
\begin{definition}[ ]\label{}
The ring $R$ is a \defn{discrete valuation ring}\index{discrete valuation ring} if it is a PID that has a unique nonzero prime ideal $\mathfrak{p}(R)$. The field $R/\mathfrak{p}(R)$ is the \defn{residue field}\index{residue field} of $R$. 
\end{definition}
