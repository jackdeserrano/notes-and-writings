...
\end{align*}
so morphisms $\Spec R\longrightarrow D_{x_j}$ are given by points of $R^n$ $(r_0:\cdots:r_{j-1}:1:r_{j+1}:\cdots:r_n)$. One glues the $D_{x_j}$s together and sees that morphisms $\varphi$ such that 
\[
\begin{tikzcd}
