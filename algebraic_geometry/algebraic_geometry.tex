...
The claim is that there is a functor 
\[
\begin{tikzcd}
...
Write $\catn{PAb}:=\catn{PAb}(\mathscr{T})$ and $\catn{Ab}:=\catn{Ab}(\mathscr{T})$. 
Since $\catn{Ab}$ is a subcategory of $\catn{PAb}$, the adjointness property can be re-stated: there is a functorial homomorphism
\[
\begin{tikzcd}
...
A presheaf $\mathscr{F}\in \catn{PAb}$ induces a functor
\[
\begin{tikzcd}
