...
There are two glass spheres: one of radius $1$ and the other of radius $2$. Find two other glass spheres of rational radius that sum to the same value.\footnote{From \ul{The Canterbury Puzzles}, Henry Dudeney, problem 20.} That is, one wants to solve
\begin{align*}
	x^3 + y^3 = 1^3 + 2^3 = 9
\end{align*}
in $\Q -\{1,2\}$. Dudeney realized that
\begin{align*}
