...
\begin{definition}[Stacks project 17.8.1]\label{}\text{}
...
This also has a closed subgroup $\mu_p$ which comprises the $p$th roots of unity. This is represented by
\begin{align*}
...
Suppose that $R$ is a finite-dimensional $k$--vector space. Consider $R^* = \Hom_{k}(R, k)$. Dualizing reverses all of the arrows above, and one sees that $\Spec R^*$ is an \index{algebraic group scheme}.
