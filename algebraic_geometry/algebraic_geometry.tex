...
\fi
\subsection{\texorpdfstring{$\underline{\Proj}_X(\mathscr{F})$}{Proj_X (F)}.}
...
With this construction, one can construct projective varieties, projective bundles, blow up subschemes/sheaves of ideals, make ideals \index{locally principal ideal}locally principal, resolve singularities, make rational maps defined everywhere.
