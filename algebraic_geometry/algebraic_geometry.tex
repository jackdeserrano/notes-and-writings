...
A ring map $R\longrightarrow S$ is \defn{smooth}\index{smooth ring map} if and only if it is of finite presentation and the naive cotangent complex $\operatorname{NL}_{S/R}$ is quasiisomorphic dto a finite projective $S$-module placed in degree $0$.
\end{definition}
