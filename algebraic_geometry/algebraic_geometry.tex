...
The $\zeta$ function $\zeta_X$ of a curve $X$ over $\mathbf{F}_{q}$ is closely related to the number of points that $X$ has over some extension $\mathbf{F}_{q^f}$. One denotes this quantity $\mathup{n}_f$.
A prime divisor of $X$ of degree $d$ gives $d$ points on $X$ over $\mathbf{F}_{q^f}$ whenever $d$ divides $f$.
Therefore,
\begin{align*}
	\log(\zeta_X(s)) &= \sum_{\textrm{prime divisors $P$ of $X$, $f\ge 0$}}^{} \frac{\mathscr{N}(P) ^{-fs}}{f}\\
			 &= \sum_{\textrm{prime divisors $P$ of $X$, $f\ge 0$}}^{} \frac{q^{-\deg(P) fs}}{f}\\
			 &= \sum_{f\ge 0}^{} \mathup{n}_f \frac{q^{-fs}}{f}.
\end{align*}	
...
\end{align*}
These properties follow from the Riemann--Roch theorem.
...
%		   &\phantom{=} \ + \omega_2t + \frac{\omega_2^2t^2}{2} + \frac{\omega_2^3t^3}{3}+\cdots
	   \sum_{f\ge 1}^{} \frac{t^f}{f} + \sum_{f\ge 1}^{}  \frac{(qt) ^f}{f} + \sum_{f\ge 1}^{} \frac{(\omega_1t)^f}{f} + \cdots + \sum_{f\ge 1}^{} \frac{(\omega_{2g}t)^f}{f}\\
		   &= \sum_{f\ge 1}^{} \mathup{n}_f\frac{t^f}{f}.
\end{align*}
Therefore,
\begin{align*}
	\left\lvert \mathup{n}_f -1 - q^f \right\rvert \le 2g(q^{f/2}).
\end{align*}
...
\begin{align*}
	\log (\zeta_X(s)) := \sum_{f\ge 0}^{} \mathup{n}_f \frac{q^{-fs}}{f}.
\end{align*}
